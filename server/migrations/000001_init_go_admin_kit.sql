...
INSERT IGNORE INTO `departments` (`id`,`name`,`code`,`parent_id`,`leader`,`sort`,`status`,`created_at`,`updated_at`) VALUES
(1,'Headquarters','HQ',0,'admin',1,1,NOW(3),NOW(3));

INSERT IGNORE INTO `users` (`id`,`username`,`password`,`nickname`,`email`,`phone`,`avatar`,`department_id`,`must_change_password`,`status`,`created_at`,`updated_at`) VALUES
(1,'admin','$2a$10$x.kr72XCSvMcgkM0etydcOLlVPxYcjR8bK4sRYdf0VQmMxz8LskBe','管理员','admin@example.com',NULL,'',1,0,1,NOW(3),NOW(3));

INSERT IGNORE INTO `roles` (`id`,`name`,`code`,`description`,`data_scope`,`created_at`,`updated_at`) VALUES
...
INSERT IGNORE INTO `dict_types` (`id`,`name`,`code`,`description`,`status`,`created_at`,`updated_at`) VALUES
(1,'用户状态','user_status','常用用户状态值',1,NOW(3),NOW(3)),
(2,'公告类型','notice_type','通知公告类型值',1,NOW(3),NOW(3));

INSERT IGNORE INTO `dict_items` (`dict_type_id`,`label`,`value`,`sort`,`status`,`remark`,`created_at`,`updated_at`) VALUES
(1,'启用','1',1,1,'',NOW(3),NOW(3)),
(1,'禁用','0',2,1,'',NOW(3),NOW(3)),
(2,'通知','1',1,1,'',NOW(3),NOW(3)),
(2,'公告','2',2,1,'',NOW(3),NOW(3));

INSERT IGNORE INTO `notices` (`id`,`title`,`content`,`type`,`status`,`creator_id`,`creator`,`created_at`,`updated_at`) VALUES
(1,'欢迎使用','后台管理系统数据库已准备就绪。',1,1,1,'admin',NOW(3),NOW(3));

INSERT IGNORE INTO `wm_console_route` (`route_key`,`path`,`name`,`component_key`,`sort_order`,`enabled`,`permissions_json`,`roles_json`,`meta_json`,`created_at`,`updated_at`) VALUES
