    ...
    >
      <template #logo>
        <span v-if="showLogo" :class="`${prefix}-side-nav-logo-wrapper`" @click="goHome">
          <span class="admin-side-brand" :class="{ 'admin-side-brand--compact': collapsed }">
            <span v-if="!collapsed" class="admin-side-brand__text">
      ...
      <template #operations>
        <span v-if="!collapsed" :class="versionCls"> 后台管理系统 {{ pgk.version }} </span>
      </template>
    </t-menu>
