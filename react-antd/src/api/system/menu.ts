...
export const getMenuList = (params: MenuListParams) =>
  request.get<unknown, PageResponse<Menu>>('/api/v1/system/menus', { params })

export const getMenuTree = () =>
  request.get<unknown, Menu[]>('/api/v1/system/menus/tree')

export const createMenu = (data: MenuCreateData) =>
  request.post<unknown, Menu>('/api/v1/system/menus', data)

export const updateMenu = (id: number, data: MenuUpdateData) =>
  request.put<unknown, Menu>(`/api/v1/system/menus/${id}`, data)

export const deleteMenu = (id: number) =>
  request.delete<unknown, void>(`/api/v1/system/menus/${id}`)
