...
export const getDepartmentList = (params: DepartmentListParams) =>
  request.get<unknown, PageResponse<Department>>('/api/v1/system/departments', { params })

export const getDepartmentTree = () =>
  request.get<unknown, Department[]>('/api/v1/system/departments/tree')

export const createDepartment = (data: DepartmentCreateData) =>
  request.post<unknown, Department>('/api/v1/system/departments', data)

export const updateDepartment = (id: number, data: DepartmentUpdateData) =>
  request.put<unknown, Department>(`/api/v1/system/departments/${id}`, data)

export const deleteDepartment = (id: number) =>
  request.delete<unknown, void>(`/api/v1/system/departments/${id}`)
