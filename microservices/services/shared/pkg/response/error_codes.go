...
const (
	...
	ErrorCodePostCodeAlreadyExists                  ErrorCode = "POST_CODE_ALREADY_EXISTS"
	ErrorCodePostHasUsers                           ErrorCode = "POST_HAS_USERS"
	...
	ErrorCodeAIConversationNotFound ErrorCode = "AI_CONVERSATION_NOT_FOUND"
	ErrorCodeAIDocumentNotFound     ErrorCode = "AI_DOCUMENT_NOT_FOUND"
	ErrorCodeAIProviderError        ErrorCode = "AI_PROVIDER_ERROR"
)
