...
-- ===== AI =====
-- AI tables are owned by ai-service AutoMigrate (not present in the scaffold
-- edition): only backfill tenant_id when the tables already exist.
-- +goose StatementBegin
DO $$
BEGIN
  IF to_regclass('ai_conversations') IS NOT NULL THEN
  ...
  IF to_regclass('ai_documents') IS NOT NULL THEN
